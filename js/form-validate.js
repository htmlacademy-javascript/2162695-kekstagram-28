...
const addValidator = () => {
  pristine.addValidator(hashtagField, isValidHashtag, VALID_HASHTAG_TEXT);

  pristine.addValidator(hashtagField, isUniqueHashtags, UNIQ_HASHTAG_TEXT);

  pristine.addValidator(hashtagField, isValidCount, COUNT_HASHTAG_TEXT);

  pristine.addValidator(commentField, isValidComment, COMMENT_HASHTAG_TEXT);
};
